<?php /* Smarty version Smarty-3.1.20, created on 2016-01-24 13:39:45
         compiled from "vistas\vop.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2825056a4c611632ea8-06817005%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2825056a4c611632ea8-06817005',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56a4c6117a1207_72783174',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56a4c6117a1207_72783174')) {function content_56a4c6117a1207_72783174($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="form-group">
    ...
    <label for="ci" class="col-lg-2 control-label">Hemo</label>
    <div class="col-lg-10">
        <input type="text" class="form-control" name="hemo" id="hemo" value="<?php echo $_smarty_tpl->tpl_vars['vops']->value->getHemo();?>
" required="">
    </div>
  </div>          
  ...
  <div class="form-group">
    <label for="nombre" class="col-lg-2 control-label">XCELL</label>
    <div class="col-lg-10">
      <input type="text" class="form-control" name="xcell" id="xcell" value="<?php echo $_smarty_tpl->tpl_vars['vops']->value->getXcell();?>
" required="">
    </div>
  </div>
