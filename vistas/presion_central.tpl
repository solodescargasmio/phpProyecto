...
<body>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
        <input type="text" class="form-control" name="psis" id="psis" value="{$presionc->getPsis()}" required="">
    </div>
  </div>          
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
        <input type="text" class="form-control" name="pdias" id="pdias" value="{$presionc->getPdias()}" required="">
    </div>
  </div>
